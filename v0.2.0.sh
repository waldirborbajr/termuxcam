#!/bin/bash
# Script para criar/atualizar todos os arquivos do termuxcam
# Mantém todas as funcionalidades originais + melhorias

set -e

echo "📁 Criando/Atualizando arquivos do termuxcam..."
...
#!/bin/bash
# Script para compilar e reiniciar o serviço
...
#!/bin/bash
# Script de controle do serviço termuxcam
...
# ========== Justfile ==========
cat > Justfile << 'EOF'
# Justfile para termuxcam
# Uso: just <comando>

default:
    @just --list

# Compilar para arquitetura atual
build:
...
# ========== assets/ (criar diretório vazio) ==========
mkdir -p assets
touch assets/.keep

echo ""
echo "✅ Todos os arquivos criados/atualizados com sucesso!"
echo ""
echo "📁 Arquivos gerados:"
ls -la *.go *.mod *.sum *.conf *.example Makefile Dockerfile docker-compose.yaml build-restart.sh termuxcam-ctl Justfile 2>/dev/null || true
echo ""
echo "📁 Diretórios criados:"
ls -la .devcontainer/ assets/ 2>/dev/null || true
echo ""
echo "🚀 Para compilar:"
...
echo "  ./termuxcam-ctl status"
echo "  ./termuxcam-ctl logs"
echo ""
echo "📋 Comandos disponíveis:"
echo "  ./termuxcam --help"
echo "  ./termuxcam system"
echo "  ./termuxcam status"
echo "  ./termuxcam config"
echo "  ./termuxcam capture --burst=3"
